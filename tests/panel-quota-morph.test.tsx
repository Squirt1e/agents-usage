...
import { QuotaDisplay, type QuotaDisplayItem } from '../src/desktop/QuotaDisplay';
import {
  BAR_BOX,
  BAR_INSET,
  QUOTA_MORPH_MS,
  ...
  quotaShape,
  ringTextOpacity
} from '../src/desktop/quota-morph';
import { PANEL_ANIMATING_ATTRIBUTE } from '../src/desktop/panel-height';
